...
namespace DKMovies.Models
{
	public class ApplicationDbContext : DbContext
	{
		...
		public DbSet<Role> Roles { get; set; }  // ← SỬA: Đổi từ Order thành Role
		...
		protected override void OnModelCreating(ModelBuilder modelBuilder)
		{
			...
			modelBuilder.Entity<ShowTime>()
				...
				.HasColumnType("decimal(10,2)");  // ← SỬA: Đổi thành decimal(10,2)
			...
			// ← SỬA: Relationship ShowTime -> Ticket 
			modelBuilder.Entity<ShowTime>()
				.HasMany(st => st.Tickets)
				.WithOne(t => t.ShowTime)  // ← SỬA: Đổi từ ShowTimes thành ShowTime
			...
			// OrderItem flexible relationships
			modelBuilder.Entity<OrderItem>()
				.HasOne(oi => oi.Ticket)
